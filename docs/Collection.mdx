...
**`name`**: string - (excpet for **Collection** children of Collection of type array)
  ...
  <Form>
    <Collection object name="myObject">
      ...
      <Collection array name="sex">
        <Input type="checkbox" index="0" value="M" />
        <Input type="checkbox" index="1" value="F" />
      </Collection>
    </Collection>
  </Form>
</Playground>
...
<Playground>
      <Form>
        <Collection array name="numberList"  >
          <label>
            One: 
            <Input type="number" index="1" value="1" />
          </label>
           <label>
             Two:
            <Input type="number" index="2" value="2" />
          </label>
        </Collection>
      </Form>
</Playground>
