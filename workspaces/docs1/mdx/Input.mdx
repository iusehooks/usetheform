...
import { useValidation, useAsyncValidation } from "./../../usetheform/src";
...
- Specifies the initial value of an _input_ element.

**`checked`**: boolean

- Specifies whether an _input_ element should be pre-selected or not (for type="checkbox" or type="radio").
