...
export function CollectionObjectNestedRadios({
  ...
  return (
    <Collection object name="lv1" value={initialValue}>
      <Input type="radio" name="1" data-testid="1" value="1" />
      <Input
        type="radio"
        name="1"
        data-testid="2"
      ...
      <Collection object name="lv2">
        <Input
          ...
          checked={checked}
        />
        <Input type="radio" name="2" data-testid="4" value="4" />
        <Collection object name="lv3">
          <Input type="radio" name="3" data-testid="5" value="5" />
          <Input
            type="radio"
            name="3"
            data-testid="6"
          ...
          <Collection object name="lv4">
            <Input
              ...
              checked={checked}
            />
            <Input type="radio" name="4" data-testid="8" value="8" />
            <Collection object name="lv5">
              <Input
                type="radio"
                name="5"
                ...
                checked={checked}
              />
              <Input type="radio" name="5" data-testid="10" value="10" />
            </Collection>
          </Collection>
        </Collection>
      </Collection>
